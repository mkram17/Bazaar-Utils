...
public final class OrderFlippedDataSource extends ChatOrderSource {
    ...
    public void onOrderFlipped(BazaarChatEvent.BuyOrderFlipped event) {
        ...
        var price = OrderResolver.resolveForFlip(chatSellPrice);
        ...
        var newSell = new Order(
                ...
                isPriceExact, pricePerUnit, flipVolume, 0, 0, slotPosition,
        ...
        var mutation = BookMutation.place(transaction, price.price(), flipVolume);
