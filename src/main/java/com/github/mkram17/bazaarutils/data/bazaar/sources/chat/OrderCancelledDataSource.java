...
public final class OrderCancelledDataSource extends ChatOrderSource {
    ...
    private void onBuyOrderCancelled(BazaarChatEvent.BuyOrderCancelled event) {
        ...
        PlayerLogger.debug("%s — Cancelled — buy order: %s".formatted(origin.describe(), cancelled.describe()), NotificationType.ORDER_LIFECYCLE, LOG);
    ...
    private void onSellOfferCancelled(BazaarChatEvent.SellOfferCancelled event) {
        ...
        PlayerLogger.debug("%s — Cancelled — sell offer: %s".formatted(origin.describe(), cancelled.describe()), NotificationType.ORDER_LIFECYCLE, LOG);
