...
public final class BazaarApiConverter {
    ...
    public static ApiSnapshotEvent convert(SkyBlockBazaarReply reply) {
        ...
        BazaarDataOrigin.ApiSnapshot origin = new BazaarDataOrigin.ApiSnapshot(timestamp);
        ...
        Map<String, BookLevels<BazaarDataOrigin.ApiSnapshot>> batch = transformProducts(products, origin);

        return new ApiSnapshotEvent(batch, timestamp);
    }

    private static Map<String, BookLevels<BazaarDataOrigin.ApiSnapshot>> transformProducts(Map<String, SkyBlockBazaarReply.Product> products, BazaarDataOrigin.ApiSnapshot origin) {
    ...
    private static List<PriceLevel<BazaarDataOrigin.ApiSnapshot>> toPriceLevels(List<SkyBlockBazaarReply.Product.Summary> summaries, BazaarDataOrigin.ApiSnapshot origin) {
