...
public final class OrderResolver {
     ...
     */
    public static ResolvedPrice resolveForPlacement(double chatPrice) {
        return TransactionAPI.consume()
                .map(info -> new ResolvedPrice(info.getPricePerItem(), true))
                .orElseGet(() -> new ResolvedPrice(chatPrice, false));
    }
     ...
     */
    public static ResolvedPrice resolveForFlip(double chatPrice) {
        return TransactionAPI.consumeFlip()
                .map((parsed) -> new ResolvedPrice(parsed.sellPrice(), true))
                .orElseGet(() -> new ResolvedPrice(chatPrice, false));
    }
     ...
     */
    public static Optional<Order> forClaim(@NotNull String productId, @NotNull TransactionType transaction, double pricePerUnit, int volume, List<Order> storage) {
