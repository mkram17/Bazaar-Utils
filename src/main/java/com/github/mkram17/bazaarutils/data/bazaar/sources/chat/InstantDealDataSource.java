 ...
 *
 * <p>Each transaction walks volume off the opposite book side — instant-buy consumed
 * sell offers, instant-sell consumed buy orders. No stored order is created or updated;
 * only the book is mutated via {@link OrderDelta.BookOnly}.
 */
@DataSource
