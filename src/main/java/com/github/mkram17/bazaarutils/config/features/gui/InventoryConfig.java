...
public final class InventoryConfig {
    ...
    @ConfigEntry(
            id = "order_status_highlight:settled_color",
            translation = "bazaarutils.config.inventory.order_status_highlight.settled_color.label"
    )
    @Comment(
            value = "The color to highlight orders which have been fully filled or have expired and are awaiting flip or claim.",
            translation = "bazaarutils.config.inventory.order_status_highlight.settled_color.hint"
    )
    @ConfigOption.Color(alpha = true)
    public static int ORDER_STATUS_HIGHLIGHT_SETTLED_COLOR = 0xFFEEEEEE;
