...
public class ApiSnapshotEvent extends SkyBlockEvent {
    @Getter
    private final Map<String, BookLevels<BazaarDataOrigin.ApiSnapshot>> snapshot;

    @Getter
    private final long timestamp;

    public ApiSnapshotEvent(Map<String, BookLevels<BazaarDataOrigin.ApiSnapshot>> snapshot, long snapshotTs) {
