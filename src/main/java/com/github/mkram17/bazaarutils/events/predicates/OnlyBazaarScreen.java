 ...
 *   <li>{@link #useConstrainsInterface()} — delegate to the registering instance's
 ...
 * the order {@code useConstrainsInterface} &gt; {@code any} &gt; {@code value}, silently ignoring
 * the others.</p>
 */
...
public @interface OnlyBazaarScreen {
     ...
     * Mutually exclusive with {@code any = true} and {@code useConstrainsInterface = true}.
     */
