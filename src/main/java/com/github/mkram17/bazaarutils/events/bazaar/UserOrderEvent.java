 ...
 * position other than whichever one is being played.
 */
public sealed class UserOrderEvent extends SkyBlockEvent implements ProfileScopedEvent permits
    ...
    /**
     * An order lapsed its Hypixel lifetime. The order remains actionable:
     * the player must claim any filled volume, then cancel or flip via Options,
     * to recover the coins or items still held in escrow for the unfilled remainder,
     * or to post the filled unclaimed volume to the other side of the book.
     */
