...
public sealed class UserOrderEvent extends SkyBlockEvent permits
    ...
    public static final class PartiallyFilled extends UserOrderEvent {
        ...
        public PartiallyFilled(Order order, int filledDelta) {
            super(order);
    ...
    public static final class Claimed extends UserOrderEvent {
        ...
        public Claimed(Order order, int claimedDelta) {
            super(order);
    ...
    /**
     * An order's Hypixel 7-day lifetime lapsed. Its unfilled volume has been removed from the
     * market book. The order remains live — the player must claim any filled volume and then
     * cancel via Options to recover the unfilled escrow.
     */
    public static final class Expired extends UserOrderEvent {
        public Expired(@NotNull Order order) {
            super(order);
        }
    }
