...
public class ItemSlotButtonWidget extends ImageButton {
    ...
    @Override
    //? if > 26.1 {
    public void extractContents(net.minecraft.client.gui.GuiGraphicsExtractor context, int mouseX, int mouseY, float delta) {
        super.extractContents(context, mouseX, mouseY, delta);
    //? } else {
    /*public void extractWidgetRenderState(DrawContext context, int mouseX, int mouseY, float delta) {
