...
public class SearchBookmarkWidget {
    ...
    public static List<ItemSlotButtonWidget> getWidgets() {
        ...
        for (Bookmark bookmark : bookmarks) {
            ...
            OptionalDouble instaBuy = PriceInfo.priceForPosition(bookmark.productId(), TransactionType.of(TransactionType.Side.BUY, TransactionType.Method.INSTANT), PricingPosition.MATCHED);
            OptionalDouble instaSell = PriceInfo.priceForPosition(bookmark.productId(), TransactionType.of(TransactionType.Side.SELL, TransactionType.Method.INSTANT), PricingPosition.MATCHED);
