...
public class InstantBuyAmountHelper extends SignInputHelper.TransactionAmount {
    ...
    public TransactionType2 transactionType = TransactionType2.of(TransactionType2.Side.BUY, TransactionType2.Method.INSTANT);
    public TransactionType2.Method transactionMethod = TransactionType2.Method.INSTANT;
