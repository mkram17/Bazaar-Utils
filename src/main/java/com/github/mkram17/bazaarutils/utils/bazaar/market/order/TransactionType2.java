...
public class TransactionType2 {
    ...
    private TransactionType2(Side side, Method method) {
        this.side = side; this.method = method;
        this.priceType = resolvePriceType(side, method);
    }

    public static TransactionType2 of(Side side, Method method) {
        return new TransactionType2(side, method);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TransactionType2 other) return priceType == other.priceType;
