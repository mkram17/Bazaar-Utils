...
public final class PageSummaryParser {
    ...
    public record PageSummaryResult(List<PriceLevel<BazaarDataOrigin.PageSummary>> bidLevels, List<PriceLevel<BazaarDataOrigin.PageSummary>> askLevels, long observedAt) {}

    private PageSummaryParser() {}

    public static BookLevels<BazaarDataOrigin.PageSummary> parseItemPage(ItemStack buyOrderStack, ItemStack sellOfferStack, BazaarDataOrigin.PageSummary origin) {
    ...
    private static List<PriceLevel<BazaarDataOrigin.PageSummary>> parsePriceLevels(ItemStack stack, BazaarDataOrigin.PageSummary origin) {
    ...
    private static Optional<PriceLevel<BazaarDataOrigin.PageSummary>> parsePriceLevel(Component line, BazaarDataOrigin.PageSummary origin) {
        ...
        try {
            ...
            return Optional.of(new PriceLevel<BazaarDataOrigin.PageSummary>(price, volume, orders, origin));
